...
public class TelaListaOS extends javax.swing.JInternalFrame {
    ...
    public TelaListaOS(JDesktopPane telaAnterior) {
        ...
        TableRowSorter<TableModel> sorter = new TableRowSorter<>(jTableOSs.getModel());
            ...
            if (listaOSs != null && !listaOSs.isEmpty()) {//    * caso exista alguma OS para mostrar
                for (OrdemDeServico os : listaOSs) {
                    ...
                    String dados[] = {String.valueOf(os.getCodigo()),// * código da OS
                        ...
                        String.format("%10.2f", servico.getValorMaoDeObra()),//  * valor da mão de obra
                        ...
                        String.format("%10.2f", os.calcularValorTotalSemDesconto()),// * valor total da OS, sem desconto
                        String.format("%10.2f", os.calcularValorTotalComDesconto())};// * valor total da OS, com desconto
                    ...
                    if (peca != null) {//   * usa alguma peça
                        ...
                        dados[9] = String.format("%10.2f", peca.getValorPeca());//  * valor unitário da peça
                    }
                    table.addRow(dados);
                }
            }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-pesquisar-30.png"))); // NOI18N
