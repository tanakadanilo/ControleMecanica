...
public class Endereco {
    ...
    public Endereco(String tipoLogradouro, String logradouro, String numero, String complemento, String bairro, String cidade, EstadosBrazil estado, String CEP) throws InvalidInputException {
        if (!ValidaCep(CEP)) {
            throw new InvalidInputException("O CEP " + CEP + " é inválido");
        }
